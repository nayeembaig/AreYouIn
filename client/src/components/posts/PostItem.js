...
const PostItem = ({
  ...
  <div class="message-container"  style={{border: "1px solid #EFF9FC", borderRadius: "5px", backgroundColor:"#EFF9FC"}}>
   ...
   <button
           style={{marginLeft: "630px",color:"white", backgroundColor:"lightblue"}}
            onClick={() => addLike(_id)}
            type='button'
            className='btn btn-light'
          >
          ...
          <Link to={`/posts/${_id}`} style={{color:"white",border:"None", backgroundColor:"lightblue"}} className='btn btn-primary'>
            Discussion{' '}
            {comments.length > 0 && (
