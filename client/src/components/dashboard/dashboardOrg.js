...
const DashboardOrg = ({
  ...
  return loading && profile === null ? (
    ...
    <div>
     <img src={Calendar} style={{width:"130px",height:"130px"}}></img><Link to='/landingorg'><p>Manage Events</p></Link>
     <Link to='/Addevent'><p>Add an event</p></Link>
...
<div class="grid">
            <div class="column lg12">
              <h3 class="section__title">Be a good host, Get to know your Guests!</h3>
            </div>
            <div
